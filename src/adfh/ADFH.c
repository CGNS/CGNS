                        ...
                        int          *err)
{
  ...
  */
  ...
  H5Pset_fclose_degree(mta_root->g_propfileopen, H5F_CLOSE_WEAK);
...
/*      MPI_Info_create(&info);*/
      H5Pset_fapl_mpio(mta_root->g_propfileopen, comm, info);
  }
#endif
