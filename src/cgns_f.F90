...
#  endif
  ...
  ! modes for cgp_open in serial
  INTEGER(C_INT), PARAMETER :: CG_MODE_READ_SERIAL   = 10
  INTEGER(C_INT), PARAMETER :: CG_MODE_WRITE_SERIAL  = 11
  INTEGER(C_INT), PARAMETER :: CG_MODE_MODIFY_SERIAL = 12
