...
MODULE cgns
  ...
  USE ISO_C_BINDING, ONLY : C_INT, C_FLOAT, C_DOUBLE, C_LONG_LONG, C_CHAR, C_PTR, C_FUNPTR, C_SIZE_T, C_NULL_PTR
  IMPLICIT NONE
...
!* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
  ...
  INTEGER, PARAMETER :: CG_CONFIG_HDF5_CHUNK          = 210
  INTEGER, PARAMETER :: CG_CONFIG_HDF5_FILTER         = 211

  INTEGER, DIMENSION(1), PARAMETER :: CG_CHUNK_NONE  = 0
